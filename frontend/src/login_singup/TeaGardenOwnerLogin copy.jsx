...
import b1 from "../assets/h1.png"; // Update with your image path

const TeaGardenOwnerLogin = ({ setUser }) => {
  ...
  const handleAuth = async (e) => {
    ...
    setIsLoading(true);
    const url = isLogin
      ? "http://localhost:5000/tea-garden-owner/login"
      : "http://localhost:5000/tea-garden-owner/signup";
    ...
    try {
      ...
      if (isLogin) {
        ...
        setTimeout(() => {
          navigate("/TeaGardenOwnerDashboard");
        }, 1000);
      } else {
      ...
      >
        ...
        >
          <div className="p-6">
            ...
            >
              {isLogin ? "Tea Garden Owner Login" : "Tea Garden Owner Sign Up"}
            </motion.h3>
...
export default TeaGardenOwnerLogin;
