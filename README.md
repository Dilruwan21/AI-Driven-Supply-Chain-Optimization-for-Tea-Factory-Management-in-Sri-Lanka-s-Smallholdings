#Ai Driven  Tea Factory Management System (Final Year Project)
...
- 🧠 **AI-based forecasting** using Python (predict future tea production trends)
- 📊 Real-time analytics & charts (with Chart.js)
- 🧾 Labor, Transport, Supplier, Factory Management modules
- 🌐 Built with modern technologies: MongoDB, Express.js, React.js, Node.js
